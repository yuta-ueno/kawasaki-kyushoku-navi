    ...
    <div className={`flex flex-col items-center justify-center ${sizeClasses.container}`}>
      ...
      <div className="relative mb-4">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <ChefHat className={`${sizeClasses.icon} text-blue-600 animate-pulse`} />
        </div>
      </div>

      {/* ローディングメッセージ */}
      <div className={`${sizeClasses.text} text-gray-600 font-medium animate-pulse`}>
        {message}
      </div>

      {/* サブメッセージ */}
      <div className="text-xs text-gray-400 mt-2 text-center max-w-sm">
    ...
    <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden animate-pulse">
      ...
      <div className="p-6 pb-4">
        ...
        <div className="flex items-center space-x-3 mb-4">
          <div className="bg-gray-300 rounded-xl w-16 h-12"></div>
          <div className="bg-gray-300 rounded-lg w-20 h-8"></div>
        </div>

        {/* メニュー内容 */}
        <div className="mb-4">
          <div className="bg-gray-300 rounded w-24 h-4 mb-3"></div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <div className="bg-gray-300 rounded w-12 h-3 mb-1"></div>
            ...
            <div className="flex items-center space-x-2">
              <div className="bg-gray-300 rounded-lg w-8 h-8"></div>
              <div>
                <div className="bg-gray-300 rounded w-16 h-3 mb-1"></div>
