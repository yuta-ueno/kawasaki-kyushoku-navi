      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <section className="mb-12">
          <div className="flex items-center mb-6">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900">今日の給食</h2>
        ...
        <section>
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center">
              ...
              <div>
                <h2 className="text-3xl font-bold text-gray-900">2025年7月の給食</h2>
        ...
        <footer className="mt-12 bg-white rounded-xl p-6 shadow-md border border-gray-100">
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">献立について</h3>
